...
export const popularCategories = [
  { name: 'All Templates', href: '/notion' },
  { name: 'Productivity', href: '/notion/category/productivity' },
  { name: 'Marketing', href: '/notion/category/marketing' },
  { name: 'Project Management', href: '/notion/category/project-management' },
  { name: 'Language Learning', href: '/notion/category/language-learning' },
];
...
export const cardData = [
    {
        ...
        tags: ['productivity', 'goals', 'planning', 'personal-development']
    },
    {
        ...
        tags: ['project-management', 'software', 'productivity', 'planning']
    },
    {
        ...
        tags: ['marketing', 'sales', 'outreach', 'business']
    },
    {
        ...
        tags: ['marketing', 'content', 'planning', 'productivity']
    },
    {
