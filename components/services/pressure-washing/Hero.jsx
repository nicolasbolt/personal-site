		...
		<section className="relative min-h-screen items-center justify-center overflow-hidden">
			...
			<div className="container mx-auto max-w-[1160px] relative z-10 text-center px-12 pt-48">
				<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
					<h1 className="text-5xl md:text-7xl font-bold mb-6 text-slate-900">Pressure Washing Web Design in Indianapolis</h1>
					<p className="text-xl md:text-2xl text-gray-600 mb-8 px-16 pt-8">I build high-converting websites for pressure washing companies in the Indianapolis area to help them attract more customers and generate leads.</p>
