                ...
                <div>
                    <div className="text-center lg:text-start space-y-6 mb-12">
                        <h1 className="text-5xl md:text-6xl font-bold">
                            <span className="inline bg-clip-text">Da Deep Search</span>
                        </h1>
                        <p className="text-xl text-muted-foreground md:w-10/12 mx-auto lg:mx-0 pb-8">
                            A landing page redesign built for a client to better showcase the product, connect with their ideal customers, and drive conversions.
                        </p>
                    </div>
                    
                    <div className="z-10 mx-auto">
                        <img
                            src="/da-deep-search-full.png"
                            alt="Da Deep Search Landing Page Preview"
